...
class ScenarioSerializer(serializers.Serializer):
    ...
    trust_behavior_2 = serializers.DictField()
    ...
    def create(self, validated_data):
        return Scenario(validated_data.get('name'), validated_data.get('agents'), validated_data.get('observations'),
                        ...
                        validated_data.get('trust_behavior_1'), validated_data.get('trust_behavior_2'),
    ...
    def update(self, instance, validated_data):
        ...
        instance.trust_behavior_2 = validated_data.get('trust_behavior_2', instance.trust_behavior_2)
