...
TRUST_BEHAVIOR_1 = {'A': ['direct', 'recom', 'popul', 'authority'], 'B': ['direct', 'recom', 'popul', 'authority'], 'C': ['direct', 'recom', 'popul', 'authority'], 'D': ['direct', 'recom', 'popul', 'authority'], 'E': ['direct', 'recom', 'popul', 'authority'], 'F': ['direct', 'recom', 'popul', 'authority'], 'G': ['direct', 'recom', 'popul', 'authority'], 'H': ['direct', 'recom', 'popul', 'authority']}

#he secondary artifacts fpr this scenario
TRUST_BEHAVIOR_2 = {'A': ['age', 'agree', 'provenance', 'recency', 'related', 'specificity', 'topic'], 'B': ['age', 'agree', 'provenance', 'recency', 'related', 'specificity', 'topic'], 'C': ['age', 'agree', 'provenance', 'recency', 'related', 'specificity', 'topic'], 'D': ['age', 'agree', 'provenance', 'recency', 'related', 'specificity', 'topic'], 'E': ['age', 'agree', 'provenance', 'recency', 'related', 'specificity', 'topic'], 'F': ['age', 'agree', 'provenance', 'recency', 'related', 'specificity', 'topic'], 'G': ['age', 'agree', 'provenance', 'recency', 'related', 'specificity', 'topic'], 'H': ['age', 'agree', 'provenance', 'recency', 'related', 'specificity', 'topic']}
